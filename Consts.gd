...
const BUILTINS = ['print', 'highlight', 'get_tile_info', 'get_actor_by_name', 'get_actor_by_grid_position', 'get_actors', 'get_player_actors', 'get_enemy_actors', 'get_shortest_path']
const SEPARATORS = ['(', ')', '{', '}', ',', '[', ']', ':']
const OPERATORS = ['==', '<', '>', '+', '*']
